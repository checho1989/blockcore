...
namespace Blockcore.Features.Wallet.Helpers
{
    ...
    public class HdOperations
    {
        ...
        public static string GetAccountHdPathElectrum(int accountIndex)
        {
            return $"m";
        }
        ...
        public static string CreateHdPathElectrum(bool isChange, int addressIndex)
        {
            int change = isChange ? 1 : 0;
            return $"m/{change}/{addressIndex}";
        }
        ...
        public static bool IsChangeAddress(string hdPath)
        {
            ...
            if (hdPathParts.Length == 3)
            {
                if (int.TryParse(hdPathParts[1], out int resultShort))
                {
                    return resultShort == 1;
                }
                return false;
            }
